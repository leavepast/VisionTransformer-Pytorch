...
def main(args):
    ...
    model = VisionTransformer.from_name('R50+ViT-B_16').to(device)
    # print(model)
    # if args.weights != "":
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "/media/xjw/doc/00-ubuntu-files/vit-res/weights/model-{}.pth".format(epoch))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        ...
                        default="/home/xjw/PycharmProjects/two-branch-plant-disease/raw/two-paths-cropped-plant-doc/cropped_train/")
